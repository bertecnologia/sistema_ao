...
<head>
    <meta charset="utf-8" />
    <title><?php echo $empresa; ?> - Obras Cadastradas</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <meta name="description" content="A Ball Corporation é a fornecedora líder mundial de embalagens de alumínio inovadoras e sustentáveis para bebidas, cuidados pessoais e produtos domésticos, bem como aeroespacial e outras tecnologias e serviços." />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo BASEURL; ?>css/jquery.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo BASEURL; ?>css/buttons.dataTables.min.css">
    ...
    <script type="text/javascript" language="javascript" src="<?php echo BASEURL; ?>js/pdfmake.min.js"></script>
...
<body>
    <div class="app ng-scope app-header-fixed app-aside-fixed ">
        ...
        <!-- content -->
        <?php include_once(ABSPATH . '/content/teste/teste.php'); ?>
        <!-- / content -->
    ...
    <script type="text/javascript" src="<?php echo BASEURL; ?>_js/jquery.fancybox.pack.js"></script>
</body>
